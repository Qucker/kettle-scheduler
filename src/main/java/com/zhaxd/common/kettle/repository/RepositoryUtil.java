...
//		kRepository.setRepositoryType("MSSQL");
		kRepository.setDatabaseAccess("Native");
//		kRepository.setDatabaseHost("192.168.90.34");
		kRepository.setDatabaseHost("localhost");
//		kRepository.setDatabaseHost("192.168.3.100");
		kRepository.setDatabasePort("3306");
//		kRepository.setDatabasePort("1433");
		kRepository.setDatabaseName("kettle_repository");
//		kRepository.setDatabaseUsername("sa");
//		kRepository.setDatabasePassword("Qwe123");
//		kRepository.setDatabaseUsername("root");
//		kRepository.setDatabasePassword("root");
		kRepository.setDatabaseUsername("Km2020");
		kRepository.setDatabasePassword("Km@2020");
	...
	public static KettleDatabaseRepository connectionRepository(KRepository kRepository) throws KettleException{
		if (null != kRepository){
			...
			databaseMeta.addExtraOption("MSSQL","integratedSecurity ","false");
