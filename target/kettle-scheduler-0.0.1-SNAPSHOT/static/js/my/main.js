$(document).ready(function () {
    ...
    $.ajax({
        type: 'POST',
        async: false,
        url: 'job/record/getAllJobsToday.shtml',
        data: {},
        success: function (data) {
            $("#allNumToday").text(data);
        },
        error: function () {
            alert("请求失败！请刷新页面重试");
        },
    ...
    $.ajax({
        type: 'POST',
        async: false,
        url: 'job/record/getSuccessJob.shtml',
        data: {},
        success: function (data) {
            $("#jobSuccessNum").text(data);
        },
        error: function () {
            alert("请求失败！请刷新页面重试");
        },
    ...
    $.ajax({
        type: 'POST',
        async: false,
        url: 'job/record/getFailJob.shtml',
        data: {},
        success: function (data) {
            $("#jobFailNum").text(data);
        },
        error: function () {
            alert("请求失败！请刷新页面重试");
        },
