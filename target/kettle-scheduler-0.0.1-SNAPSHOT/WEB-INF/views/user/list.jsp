        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <table id="userList" data-toggle="table"
					...
					<thead>
						<tr>
							<th data-field="uId" data-formatter="IdFormatter">用户编号</th>
	...
	<script>
	    ...
	    window.actionEvents = {
            ...
            function IdFormatter(value, row, index) {
                ...
                // alert(id)
                // var pageSize=$('#userList').bootstrapTable('getOptions').pageSize;
                // alert(pageSize)
                // var pageNumber=$('#userList').bootstrapTable('getOptions').pageNumber;
                // alert(pageNumber)
