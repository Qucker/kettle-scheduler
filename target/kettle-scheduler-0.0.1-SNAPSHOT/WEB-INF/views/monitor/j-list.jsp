    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
                ...
                <div class="col-sm-12">
                    <div class="form-inline text-right">
                        <div class="form-group">
                            <label class="control-label m-b-xs" for="userId">请选择监控对象：</label>
            ...
            <table id="jobMonitorList" data-toggle="table"
                ...
                <thead>
                <tr>
                    <th data-field="monitorId" data-formatter="IdFormatter">记录编号</th>
...
<%--                    <th data-field="uNickname">创建者</th>--%>
                </tr>
                </thead>
            </table>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'POST',
            async: false,
            url: 'user/getSimpleList.shtml',
            data: {},
            success: function (data) {
                for (var i = 0; i < data.length; i++) {
                    $("#userId").append('<option value="' + data[i].uId + '">' + data[i].uNickname + '</option>');
                }
            },
            error: function () {
                alert("请求失败！请刷新页面重试");
    ...
    function queryParams(params) {
        var temp = {limit: 10, offset: params.offset,userId: $("#userId").val(), categoryId: $("#categoryId").val(), jobName: $("#jobName").val(),monitorStatus:$("#monitorStatus").val()};
        return temp;
    };
